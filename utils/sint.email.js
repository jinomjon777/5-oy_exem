...
Hisobingizni tasdiqlash uchun bir qadam qoldi
</div>

<div style="margin-top:10px;font-size:14px;color:#cbd5e1;line-height:22px;">
Platformaga kirishni yakunlash uchun quyidagi tasdiqlash kodini kiriting.
</div>
</td>
</tr>
...
<div style="margin-top:14px;display:inline-block;background:#ffffff;color:#111827;border-radius:14px;padding:14px 18px;font-size:28px;font-weight:800;letter-spacing:.30em;">
${code}
</div>
...
Hurmat bilan, Avto Market jamoasi
</div>
</td>
</tr>
